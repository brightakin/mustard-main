  ...
  return (
    <Fragment>
      ...
      <div className="flex flex-col ">
        <div className="flex flex-col justify-between w-[102rem] h-[210rem] bg-[#28a745] px-12 pb-[12.25rem] ">
        ...
        <div className="flex flex-col w-[102rem] h-[110rem] bg-[#28a745] px-12 pt-[10rem] pb-[12.25rem] ">
          <div>
            <img
        ...
        <div className="flex flex-col w-[102rem] h-[28rem] bg-[#f8f7fa] ">
